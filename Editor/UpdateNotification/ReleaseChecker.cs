...
namespace Net._32ba.ReloadUploadedAvatar.UpdateNotification
{
    [InitializeOnLoad]
    internal static class ReleaseChecker
    {
        private const string PackageId = "net.32ba.reload-uploaded-avatar";
        private const string PackageDisplayName = "Reload Uploaded Avatar";
        private const string ReleasePageUrl = "https://github.com/32ba/VRC-reload-uploaded-avatar/releases";
        private const string LastCheckKeyPrefix = "net.32ba.reload.uploaded.avatar.LastVersionCheck";
